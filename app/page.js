    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main className="mx-auto max-w-6xl px-4 py-7">
        ...
        <section className="mt-8 border border-slate-700 bg-slate-900 p-5">
          <h2 className="text-xl font-bold text-white">ショップに見せやすいカルテ</h2>
          <p className="mt-2 max-w-3xl leading-7 text-slate-300">
            水質、水換え、使っている添加剤、写真を1画面に整理します。スマートフォンをそのまま店員へ見せて相談できます。
          </p>
          <Link
            href="/lite/shop-card"
            className="mt-5 flex min-h-14 w-full max-w-sm items-center justify-center border-2 border-emerald-500 px-5 py-3 text-lg font-bold text-emerald-100"
          >
            ショップに見せる
          </Link>
        </section>
