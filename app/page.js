...
const PAGE_TEXT = {
  ja: {
    ...
    heroTitle: 'Coral DB Lite',
    heroBody: '海水水槽の水質測定と、ショップに見せやすい水槽カルテをまとめて管理します。サンゴDBはCoral DB Proへ向けて整備中です。',
    summaryWater: '水質ログ',
  ...
  en: {
    tabs: { water: 'Water Log', coral: 'Coral DB Pro', identity: 'DB Cleanup', cleanup: 'More Cleanup', quality: 'DB Quality' },
    language: 'Language',
    heroKicker: 'Marine aquarium manager',
    heroTitle: 'Coral DB Lite',
