...
// The pre-Lite application remains available for internal review only.
...
const PAGE_TEXT = {
  ...
  en: {
    tabs: { water: 'Water Log', coral: 'ReefChart Pro', identity: 'DB Cleanup', cleanup: 'More Cleanup', quality: 'DB Quality' },
    language: 'Language',
