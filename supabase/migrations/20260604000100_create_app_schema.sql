-- Initial schema managed by Supabase migrations.
-- Existing tables are preserved when this migration is applied to the current project.
...
SELECT 'Main Reef Tank', 'Default aquarium created by the initial migration.'
